...
function DetailRestaurant() {
    ...
    useEffect(() => {
        axiosInstance(`/api/Restaurant/GetByName/${name}`)
          .then((response) => {
    ...
    <Header/>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-8">
              ...
              <h2 className="pd-title" style={{fontWeight:'bold', fontSize:'40px'}}> {restaurant ? restaurant.name : ""}</h2>
        <div className="pd-thumb">
          <img src={restaurant?.images[0]?.imageUrl} alt="imgDetail" />
        </div>
        <div className="header-bottom">
          <div className="pd-lavel d-flex justify-content-between align-items-center flex-wrap gap-2">
            <h3 className="location" style={{ fontWeight:'600'}}>
              Price: <p style={{fontSize:'32px',fontWeight:'bold'}}>${restaurant?.price}</p> Per Person / Day
            </h3>
      ...
      <div className="package-details-tabs">
        ...
        >
          ...
          <li className="nav-item" role="presentation">
            <button
              ...
              aria-selected="false"
            >
              <i className="bi bi-images" /> Restaurant Gallary
            </button>
          </li>
          <li className="nav-item" role="presentation">
            <button
        ...
        <div className="tab-content" id="pills-tabContent">
          ...
          >
            <h3 className="d-subtitle">Restaurant Details</h3>
            <p>
              {restaurant ? (<div dangerouslySetInnerHTML={{ __html: restaurant.description }} />) : ("")}
            </p>
            <div className="p-info-featured-img row position-relative g-3  row-cols-1 row-cols-sm-2">
              <div className="col">
                <div className="featured-img">
                  <img
                    src={restaurant?.images[1]?.imageUrl}
                    alt="RestaurantIMG"
              ...
              <div className="col">
                <div className="featured-img">
                  <img
                    src={restaurant?.images[2]?.imageUrl}
                    alt="RestaurantIMG"
                    style={{width:'100%', height:'280px', objectFit:'cover', borderRadius:'8px'}}
                  />
                </div>
            ...
            <p className="d-subtitle">Hotline: {restaurant?.contactNumber}</p>
            ...
            >
              <div className="comment-form">
                ...
                <div className="custom-input-group">
                  <input type="text" placeholder="Restaurant Type" id="type" />
                </div>
                <div className="custom-input-group">
                  <textarea
                    cols={20}
