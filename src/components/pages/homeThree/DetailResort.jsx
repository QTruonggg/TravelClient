...
function DetailResort() {
    ...
    useEffect(() => {
        axiosInstance(`/api/Resort/GetByName/${name}`)
          .then((response) => {
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-8">
              ...
              <h2 className="pd-title" style={{fontWeight:'bold', fontSize:'40px'}}> {resort ? resort.name : ""}</h2>
        <div className="pd-thumb">
          <img src={resort?.images[0]?.imageUrl} alt="imgDetail" />
        </div>
        <div className="header-bottom">
          <div className="pd-lavel d-flex justify-content-between align-items-center flex-wrap gap-2">
            <h3 className="location" style={{ fontWeight:'600'}}>
              Price: <p style={{fontSize:'32px',fontWeight:'bold'}}>${resort?.price}</p> Per Person / Day
            </h3>
      ...
      <div className="package-details-tabs">
        ...
        >
          ...
          <li className="nav-item" role="presentation">
            <button
              ...
              aria-selected="false"
            >
              <i className="bi bi-images" /> Resort Gallary
            </button>
          </li>
          <li className="nav-item" role="presentation">
            <button
        ...
        <div className="tab-content" id="pills-tabContent">
          ...
          >
            ...
            <p className="d-subtitle">Hotline: {resort?.contactNumber}</p>
            ...
            >
              <div className="comment-form">
                ...
                <div className="custom-input-group">
                  <input type="text" placeholder="Resort Type" id="type" />
                </div>
                <div className="custom-input-group">
                  <textarea
                    cols={20}
